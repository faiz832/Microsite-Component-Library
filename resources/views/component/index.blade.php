                        ...
                        @foreach ($components as $component)
                            <tr>
                                ...
                                <td
                                    ...
                                    {{ $component->Version->version }}</td>
                                <td
                                    class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium text-gray-900 dark:text-white">
                                    {{ $component->Category->category }}</td>
                                <td
                                    class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium text-gray-900 dark:text-white max-w-[270px] truncate">
