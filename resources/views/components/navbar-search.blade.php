<div x-data="searchComponent()" @keydown.window.escape="isOpen = false" @keydown.window.ctrl.k.prevent="isOpen = true">
    ...
    <div x-show="isOpen" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
        ...
        <div x-show="isOpen" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
            ...
            class="absolute inset-0 bg-gray-500/70 transition-opacity dark:bg-gray-900/70" @click="isOpen = false"
            aria-hidden="true">
        </div>
        ...
        <div x-show="isOpen" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 scale-95"
            ...
            <ul x-show="!isSearching && Object.keys(searchResults).length > 0"
                class="max-h-72 scroll-py-2 overflow-y-auto pb-6 text-sm text-gray-800 dark:text-gray-200">
