            ...
            <div class="min-h-[calc(100vh-130px)]">
                <div class="px-4 sm:px-6 md:px-8">
                    <div class="relative max-w-5xl mx-auto py-14 sm:pt-24 lg:pt-32">
                        ...
                        <p class="mt-6 text-lg text-slate-600 text-center max-w-3xl mx-auto dark:text-slate-400">A utility-first CSS framework packed with classes like <code class="font-mono font-medium text-purple-500 dark:text-purple-400">flex</code>, <code class="font-mono font-medium text-purple-500 dark:text-purple-400">pt-4</code>, <code class="font-mono font-medium text-purple-500 dark:text-purple-400">text-center</code> and <code class="font-mono font-medium text-purple-500 dark:text-purple-400">rotate-90</code> that can be composed to build any design, directly in your markup.</p>
                        <div class="mt-6 sm:mt-10 flex justify-center space-x-6 text-sm">
                            <a class="bg-slate-900 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 text-white font-semibold h-12 px-6 rounded-lg w-full flex items-center justify-center sm:w-auto dark:bg-purple-500 dark:highlight-white/20 dark:hover:bg-purple-400 transition" href="/docs/installation">
                                Get started
                            </a>
                            <button type="button" class="hidden sm:flex items-center w-72 text-left space-x-3 px-4 h-12 bg-white ring-1 ring-slate-900/10 hover:ring-slate-300 focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-sm rounded-lg text-slate-400 dark:bg-slate-800 dark:ring-0 dark:text-slate-300 dark:highlight-white/5 dark:hover:bg-slate-700">
